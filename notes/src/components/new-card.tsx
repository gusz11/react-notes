...
export function NewCard({ onNoteCreated }: NewCardProps){
  ...
  function handleStopRecording(){
    ...
    return (
      <Dialog.Root>
        <Dialog.Trigger className="rounded-md text-left flex-col bg-slate-700 p-5 gap-3 overflow-hidden relative outline-none hover:ring-2 hover:ring-slate-600 focus:ring-2 focus:ring-lime-400">
